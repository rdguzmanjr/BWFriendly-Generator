...
let s3URLFolder = "";
let s3URL =     "https://assets.nativetouch.io/2024/"+s3URLFolder.replace(/^\/|\/$/g, "");
let s3URLimage = "";
let s3URLJs =   "";
let s3ClientURL = "";
let adSize={};
...
var outputObj={};
 ...
 function fetchValue(){
    ...
    s3URL =  "https://assets.nativetouch.io/2024/"+s3URLFolder;
...
`   <iframe src="***clientS3Path***" frameborder="0" width="***clientW***" height="***clientH***" scrolling="no"></iframe>\n`+
`   <script>\n`+
